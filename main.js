...
function execute() {
	...
	function callSongs() {
		if (userInput == 'cangco' && time == 'day') {
			...
			if (AgeNumber < 30) {
				return [
					'David Kushner - Daylight bởi Stephcynie',
					'Harry Styles - As It Was bởi Will Gittens',
					'Maroon 5 - Memories bởi Bobby Brinker',
					'Miley Cyrus - Flower bởi John Tucker',
					'Olivia Rodrigo - drivers license bởi Sela Bruce',
					'Photograph - Ed Sheeran bởi Bea Miller',
					'Someone You Loved - Lewis Capaldi bởi Boyce Avenue'
					]
			}
			else {
				return [
		...
		else if (userInput == 'tramcam') {
			return ['Chopin - Prelude B Minor', 'Debussy - Clair de Lune', 'Ludovico Einaudi - Divenire', '-', '-'];
		}
		else {
			return ['spanish']
		}
